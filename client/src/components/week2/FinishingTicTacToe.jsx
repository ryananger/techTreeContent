...
{`const gameDraw = function(squares) {
  ...
  return false;
        ...
        <h3>2. Updating the Game Status</h3>
...
{`return (
  <div className='gameBoard v c anchor'>
    ...
    <button className='resetButton v c' onClick={handleReset}>RESET</button>}
        ...
        <p>In this return statement, the reset button is displayed only if the game has either a winner or is a draw. This ensures that the reset option only appears when the game has concluded.</p>

        <h3>4. Summary</h3>
        <p>With these changes, our Tic-Tac-Toe game is now more user-friendly. The draw condition ensures that games are recognized as draws when appropriate, and the reset button allows for quick restarts, making the game more enjoyable to play.</p>
